...
Status: agreed product and coaching requirements, 26 August 2026  
Purpose: define the next version before implementation
...
- Default to a full-body athletic session.
- Regularly use complexes; do not reserve them only for novelty.
- Build around suitable combinations of swings/power, squats, presses, rows and trunk work.
- Use the two-round circuit approach for 20-minute sessions.
...
- A standard Kettlebell workout is full-body and athletic.
- Complexes appear regularly.
- A 20-minute Kettlebell workout uses two circuit rounds.
